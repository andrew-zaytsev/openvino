...
8. <a href="#next-steps">Get Started with sample code and Demo Applications</a>
...
Or proceed to the <a href="#next-steps">Next Steps</a> to get started.
...
Proceed to the <a href="#next-steps">Next Steps</a> to get started.
...
Now you are ready to get started. To continue, see:
* [Get Started Guide](get_started/get_started_linux.md) to learn the basic OpenVINO™ toolkit workflow running code samples and demo applications with pre-trained models on different inference devices.
